...
push_debug_vertex :: inline proc(rendermode: Rendermode_Proc, a: Vec3, color: Colorf) {
	v := Buffered_Vertex{0, 0, a, {}, color, rendermode, shader_rgba, {}, false, full_screen_scissor_rect()};
