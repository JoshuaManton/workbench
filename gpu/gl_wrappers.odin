...
#assert(size_of(Framebuffer_Attachment) == size_of(u32));
    ...
    set_vertex_format_ti :: proc(_ti: ^rt.Type_Info, loc := #caller_location) {
        ...
        for name, _i in ti.names {
            ...
            log_errors(fmt.tprint("set_vertex_format: VertexAttribPointer", " name: ", name), loc);
            ...
            log_errors("set_vertex_format: VertexAttribDivisor", loc);
        }
    }
